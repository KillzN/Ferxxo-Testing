...
handler.all = async function (m) {
    ...
    //creador y otros
    global.creador = 'Wa.me/5493812410831'
    global.ofcbot = `${conn.user.jid.split('@')[0]}`
    global.asistencia = 'https://wa.me/qr/PAOHAKCEHGUXN1'
    global.namechannel = 'FERXXOBOT'
    ...
    //Emojis determinado de FERXXOBOT Bot
    global.emoji = '🍁'
    global.emoji2 = '⭐'
    global.emoji3 = '✨️'
    global.emoji4 = '😴'
    ...
    // global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5493812410831-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: `${packname}`, orderTitle: 'Bang', thumbnail: icons, sellerJid: '0@s.whatsapp.net'}}}
    ...
    global.icono = [
        'https://i.ibb.co/RTW0k9qC/Ferxxo.jpg',
        'https://i.ibb.co/RTW0k9qC/Ferxxo.jpg',
        'https://i.ibb.co/RTW0k9qC/Ferxxo.jpg'
    ].getRandom()
